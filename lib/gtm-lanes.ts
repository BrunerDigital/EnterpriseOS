...
export const gtmLanes: GTMLane[] = [
  {
    ...
    subheadline:
      "Package Digital360 under your brand so clients see a modern operating system for leads, follow-up, reviews, reporting, billing, portals, and campaign proof.",
    ...
    ads: [
      ...
      { channel: "Search", hook: "White label CRM for agencies", copy: "Launch a premium client portal and recurring SaaS-enabled offer with Digital360." }
    ],
    salesScript: [
  ...
  },
  {
    ...
    subheadline:
      "Digital360 by BrunerDigital gives local service teams one system for lead capture, speed-to-lead follow-up, booking, pipeline tracking, reviews, and revenue reporting.",
  ...
  },
  {
    ...
    subheadline:
      "Digital360 centralizes local lead handling, campaign governance, reviews, routing, reporting, and location scorecards without taking execution away from the field.",
    ...
    ads: [
      ...
      { channel: "Search", hook: "Multi location marketing platform", copy: "Centralize local execution and executive reporting with Digital360." },
